...
4. Creating UI wireframes for login, dashboard, and tracking features
5. Developing a basic login prototype
6. Creating the test plan for later evaluation
...
4. Conducting usability testing with users
5. Collecting feedback and identifying issues
6. Updating Trello progress and burndown chart
...
4. Collecting GitHub and Trello evidence
5. Preparing presentation slides
6. Rehearsing the final presentation
7. Submitting the completed project
